...
def portfolio_start_balance(portfolio, start_date):
    ...
    adj_positions_df.to_csv('Adjusted_Positions.csv')
...
active_portfolio.to_csv('active_portfolio.csv')
# End Balance for the end date specified

positions_per_day = time_fill(active_portfolio, market_cal)
for pos in positions_per_day:
    pos.to_csv('pos.csv')
